# Contributing to Odyssey SSE

Thanks for your interest in contributing to Odyssey SSE! We welcome pull requests, issues, and feedback from the community.
...
- `feat: add support for new event type`
- `fix: handle edge case in SSE connection`
- `docs: add error handling examples to README`
- `test: add integration tests for custom configurations`
