...
public class NatsEventLogAutoConfiguration {

  @Bean
  @ConditionalOnMissingBean(Connection.class)
  public Connection natsConnection(NatsEventLogProperties properties)
  ...
  @Bean
  public NatsOdysseyEventLog natsOdysseyEventLog(
      Connection connection, NatsEventLogProperties properties) {
