...
public class MongoEventLogAutoConfiguration {

  @Bean
  public MongoOdysseyEventLog mongoOdysseyEventLog(
      MongoTemplate mongoTemplate, MongoEventLogProperties properties) {
    MongoOdysseyEventLog eventLog =
