...
class MongoEventLogAutoConfigurationTest {

  private static MongoTemplate createMockMongoTemplate() {
    ...
    new ApplicationContextRunner()
        .withConfiguration(
            AutoConfigurations.of(
                MongoEventLogAutoConfiguration.class, OdysseyAutoConfiguration.class))
        .withUserConfiguration(MockMongoConfiguration.class)
  ...
  static class MockMongoConfiguration {
    ...
    MongoTemplate mongoTemplate() {
      return createMockMongoTemplate();
    }
  }
}
