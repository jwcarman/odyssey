...
public class RabbitMqNotifierAutoConfiguration {
  ...
  @Bean
  public RabbitMqOdysseyStreamNotifier rabbitMqOdysseyStreamNotifier(
      RabbitTemplate rabbitTemplate,
      ConnectionFactory connectionFactory,
      RabbitMqNotifierProperties properties) {
    return new RabbitMqOdysseyStreamNotifier(
        rabbitTemplate, connectionFactory, properties.exchangeName());
  }
}
