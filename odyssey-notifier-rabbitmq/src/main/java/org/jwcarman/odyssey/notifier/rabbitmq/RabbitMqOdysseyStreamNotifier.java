...
public class RabbitMqOdysseyStreamNotifier implements OdysseyStreamNotifier, SmartLifecycle {
  ...
  public void notify(String streamKey, String eventId) {
    byte[] body = (streamKey + DELIMITER + eventId).getBytes(StandardCharsets.UTF_8);
