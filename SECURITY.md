...
We aim to support the latest stable release of Odyssey SSE and provide critical security patches as needed.
...
If you discover a security vulnerability in Odyssey SSE, please report it responsibly:

**Please DO NOT report security vulnerabilities through public GitHub issues, pull requests, or discussions.**

Instead, please report via:
- **GitHub Security Advisories**: https://github.com/jwcarman/odyssey/security/advisories/new (preferred)
