...
class PostgresEventLogAutoConfigurationTest {
  ...
  void createsPostgresEventLogBean() {
    new ApplicationContextRunner()
        ...
        .withUserConfiguration(MockPostgresConfiguration.class)
        .run(
            context -> {
    ...
    new ApplicationContextRunner()
        .withConfiguration(
            AutoConfigurations.of(
                PostgresEventLogAutoConfiguration.class, OdysseyAutoConfiguration.class))
        .withUserConfiguration(MockPostgresConfiguration.class)
  ...
  static class MockPostgresConfiguration {
